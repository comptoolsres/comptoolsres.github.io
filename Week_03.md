...
* **Quiz 1: Due {{site.quiz_1_due}}.**
  * Covers basic Linux commands like: `pwd, cd, ls, less, cp, mv, mkdir, rm, which, man, cat, sort, uniq, wc, head, tail, echo, history, grep, cut, paste, join, diff, tr, sed`
* Work on Problem Set 1 (Due {{site.ps_1_due}})
