...
## What is <i class="fa fa-git-square fa-2x">?
...
* GitHub will set up your assignment, but then give you an error saying that "You no longer have access to your assignment repository." Sorry about that, not terribly user friendly, but seems to be how GitHub works.
    ...
    {% include image.html file='git_no_access.png' alt="Screenshot of screen showing that You no longer have access to your assignment repository" position="center" max-width=350 %}
    ...
    * That email has a "View invitation" button to accept your invitation to collaborate on the repository.
       ...
       {% include image.html file='git-accept-invitation.png' alt="Screenshot of screen showing that You no longer have access to your assignment repository" position="center" max-width=350 %}
