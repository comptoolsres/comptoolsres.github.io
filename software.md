...
For students enrolled in the course at UF, you will do most of your work on the universities supercomputer, HiPerGator. An account will be created for you and we will walk through everything in class, so don't worry. There are still some applications that will make it easier to work as noted below.

### For people not enrolled in the course

If you are working through this course outside of a formal class, the content is freely available on this site and the main thing you need is a Linux environment and Python. Both of these are already present on a Mac and you are set. For Windows users, I recommend installing the Ubuntu Windows Subsystem for Linux (free from the Microsoft App Store) and Anaconda for Python 3.7 or later (free from [https://www.anaconda.com/](https://www.anaconda.com/)). The main thing not available through the website are the quizzes.

## Software

Everything we do in class, *could* be done with UF Research Computing's Open OnDemand environment, which is accessible from your web browser at: [https://ood.rc.ufl.edu/](https://ood.rc.ufl.edu/)

{% include note.html content="Please see this page for details and additional Open on Demand help: [https://docs.rc.ufl.edu/interfaces/ood/](https://docs.rc.ufl.edu/interfaces/ood/)" %}
...
1. A text editor:
   1. **Microsoft [VSCode](https://code.visualstudio.com/)**: This is what I use. It has many extensions that are quite helpful. It is also free.
